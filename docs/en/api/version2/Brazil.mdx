...
<Warning>
**Before reading this API documentation, please make sure to first review the [API Description Guide](/docs/en/guide/api_description_guide)**
</Warning>
...
| phone          | Yes      | String | Real phone number (refer to the [phone format](/docs/en/guide/frequently_asked_question.html#phone_format))                                                                                                      |
| email          | Yes      | String | Real email address                                                                                                                                                                                               |
| notifyUrl      | No       | String | Callback URL                                                                                                                                                                                                     |
