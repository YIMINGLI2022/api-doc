...
<Warning>
**Before reading this API documentation, be sure to review the [**API Description Guide**](/en/docs/guide/api_description_guide)**
</Warning>
...
| phone              | Yes      | String   | Real phone number (format reference [Phone Number Format](/en/docs/guide/frequently_asked_question#phone_format)) |
...
<Tip title="Online Demo (Test Environment, No Real Charges)">
