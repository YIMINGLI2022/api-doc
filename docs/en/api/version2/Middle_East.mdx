...
| --- | --- | --- | --- |
| firstName | Yes | String | Recipient’s first name |
| lastName | Yes | String | Recipient’s last name |
| dateOfBirth | Yes | String | Date of birth (format example: DD-MM-YYYY) |
| countryCode | Yes | String | Country code (e.g., AE for United Arab Emirates) |
| street | Yes | String | Street address |
| city | Yes | String | City |
| state | Yes | String | Emirate/Province |
| postalCode | Yes | String | Postal code |
| phoneCode | Yes | String | Phone area code (e.g., "+971" for UAE) |
