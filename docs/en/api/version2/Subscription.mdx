...
:::warning
**Before reading this API documentation, be sure to review [**API Description Guide**](/en/docs/guide/api_description_guide.md) and [**Subscription Process**](/en/docs/api/version2/subscription-process.md)**
