...
| Signature Req.  | Both request and response data must be signed and verified. See [Configuration & Signature Rules](/docs/en/guide/config_settings_and_signature_rules_guide) for details |
...
For details, see [API Documentation](/docs/en/guide/api_doc_list).
...
| sign      | Yes      | String  | Signature (see [Configuration & Signature Rules](/docs/en/guide/config_settings_and_signature_rules_guide)) |
