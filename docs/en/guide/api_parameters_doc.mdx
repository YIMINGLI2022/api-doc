...
**URL**: `/{currency}/collect/apply`, where {currency} is the currency. See [Supported Countries and Currencies](/docs/en/version2/guide/supported-country-region-currency)
...
| :-------------- | :------- | :------ | :------------------------------------------------------------------------------------------------ |
| appId           | Yes      | Long    | Business ID (retrieved from backend, see [Merchant Integration Process](/docs/en/version2/guide/integration_process_guide)) |
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>No</td>
            <td>Integer</td>
            <td>Error code, see <a href="/docs/zh/version2/guide/error_code_doc">Error Codes</a></td>
        </tr>
        <tr>
            <td colspan="2">msg</td>
            <td>Yes</td>
...
**URL**: `Provided by merchant`, see [Merchant Integration Process](/docs/en/version2/guide/integration_process_guide)
...
**URL**: `/{currency}/pay/apply`, where {currency} is the currency. See [Supported Countries and Currencies](/docs/en/version2/guide/supported-country-region-currency)
