...
欧元: `/eur/collect/apply`
说明：appId需使用欧元对应的，用户支付成功后增加欧元余额
...
| payType         | 是  | String | 非收银台模式：**BANK\_TRANSFER** 收银台模式：**CASHIER**                                       |
...
| country         | 否  | String | 收银台模式传递，参考[地区编码](#country)，传三位数字编码即可                                              |
| body            | 否  | String | 备注详情                                                                              |
