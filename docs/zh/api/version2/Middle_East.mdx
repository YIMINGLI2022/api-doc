...
| 参数名 | 必选 | 类型 | 说明                   |
| --- | --- | --- |----------------------|
| firstName | 是 | String | 收款人名                 |
| lastName | 是 | String | 收款人姓                 |
| dateOfBirth | 是 | String | 出生日期（格式示例：DD-MM-YYYY） |
| countryCode | 是 | String | 国家代码（如 AE 表示阿联酋）     |
| street | 是 | String | 街道地址                 |
| city | 是 | String | 城市                   |
| state | 是 | String | 州/省份                 |
| postalCode | 是 | String | 邮政编码                 |
| phoneCode | 是 | String | 电话区号（如 "+971"）     |
