...
**URL**：`/{currency}/collect/apply`，{currency}为币种，详情参考 [交易支持的国家与币种](/docs/zh/version2/guide/supported-country-region-currency)
...
| 参数名        | 必选 | 类型    | 说明                                                                                           |
| :------------ | :--- | :------ | :--------------------------------------------------------------------------------------------- |
| appId         | 是   | Long    | 业务ID（后台获取，参考 [商户接入流程](/docs/zh/version2/guide/integration_process_guide)） |
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>否</td>
            <td>Integer</td>
            <td>错误码，详情参考 <a href="/docs/zh/version2/guide/error_code_doc">错误码</a></td>
        </tr>
        <tr>
            <td colspan="2">msg</td>
            <td>是</td>
...
**URL**：`贵方提供`，参考 [商户接入流程](/docs/zh/version2/guide/integration_process_guide)
...
**URL**：`/{currency}/pay/apply`，{currency}为币种，详情参考 [交易支持的国家与币种](/docs/zh/version2/guide/supported-country-region-currency)
