...
| 字符编码        | 统一采用UTF-8字符编码                                                                                                |
| 签名算法        | SHA256WithRSA                                                                                                        |
| 签名要求        | 请求和接受数据均需要校验签名，详细方法参考 [配置与签名](/docs/zh/guide/config_settings_and_signature_rules_guide) |
...
详情查看 [接口文档](/docs/zh/guide/api_doc_list) 。
...
| sign   | 是   | String  | 签名（详情查看 [配置与签名](/docs/zh/guide/config_settings_and_signature_rules_guide)） |
