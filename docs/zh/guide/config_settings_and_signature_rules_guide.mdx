...
#### 方式二：在线生成密钥对
通过 HaiPay 提供的开发者工具，在线生成密钥对，工具为纯js实现不会和 HaiPay 服务器进行交互，不会泄露商户密钥信息。 <a href="https://doc.haipay.net/rsa/rsa-generate/" target="_blank">生成地址</a>，也可通过其他在线生成工具生成
